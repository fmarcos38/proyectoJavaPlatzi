...
public class SwingApp extends JFrame {
    ...
    private void agregarEmpleado() throws SQLException {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            employee.setLast_name(paternoField.getText());
        ...
        if (empleadoIdStr != null) {
            try {
                ...
                if (empleado != null) {
                    ...
                    JTextField apellidoPaternoField = new JTextField(empleado.getLast_name());
                    ...
                    if (confirmResult == JOptionPane.OK_OPTION) {
                        ...
                        empleado.setLast_name(apellidoPaternoField.getText());
